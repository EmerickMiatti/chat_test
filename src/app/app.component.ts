...
export class MyApp {
  rootPage = FirstRunPage; // Page de lancement par defaut
  ...
  ]; // Tableau d'element - Les elements sont les items de notre menu
  ...
  constructor(public userProvider: UserProvider,
    ...
    platform.ready().then(() => {
      ...
      this.statusBar.styleDefault();  // StatusBar prendre la valeur par defaut
